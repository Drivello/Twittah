...
import (
	...
	"github.com/Drivello/Twittah/services/tweet/ent/migrate"
...
func (c *TweetClient) UpdateOneID(id int64) *TweetUpdateOne {
...
func (c *TweetClient) DeleteOneID(id int64) *TweetDeleteOne {
...
func (c *TweetClient) Get(ctx context.Context, id int64) (*Tweet, error) {
	return c.Query().Where(tweet.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *TweetClient) GetX(ctx context.Context, id int64) *Tweet {

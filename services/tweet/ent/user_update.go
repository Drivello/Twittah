...
func (uu *UserUpdate) AddTweetIDs(ids ...int64) *UserUpdate {
...
func (uu *UserUpdate) RemoveTweetIDs(ids ...int64) *UserUpdate {
	...
	if uu.mutation.TweetsCleared() {
		edge := &sqlgraph.EdgeSpec{
			...
			Target: &sqlgraph.EdgeTarget{
				IDSpec: sqlgraph.NewFieldSpec(tweet.FieldID, field.TypeInt64),
			},
		}
...
// AddTweetIDs adds the "tweets" edge to the Tweet entity by IDs.
func (uuo *UserUpdateOne) AddTweetIDs(ids ...int64) *UserUpdateOne {
...
// RemoveTweetIDs removes the "tweets" edge to Tweet entities by IDs.
func (uuo *UserUpdateOne) RemoveTweetIDs(ids ...int64) *UserUpdateOne {
